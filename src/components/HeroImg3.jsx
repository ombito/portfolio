  ...
  return (
    <section className="hero-section">
      ...
      <div className="about-me">
        <h2>About Me</h2>
        <p>As a cloud engineer, I have always been fascinated by the endless possibilities of cloud technology. With years <br/>of experience in the field, I have developed a deep understanding of how cloud solutions can be leveraged <br/> to drive business growth and transformation. I have been involved in numerous projects that have helped<br/> organizations modernize their infrastructure, streamline their operations and enhance their customer <br/>experience. I am also a part-time student pursuing Bachelor's degree in Business Information Technology with <br/>a comprehensive approach to learning about the latest developments in this industry. <br/> <br/>I am drawn to blockchain technology as it's an exciting and ever-evolving field that is pushing the boundaries<br/>of what is possible. When I am not at my desk, I enjoy taking road trips to discover new places and see the <br/> world from a fresh perspective. Ultimately, whether I am in the road or in the cloud I am unceasingly in pursuit<br/> of new opportunities to learn and advance my professional development.</p>
